...
public class ADIDAS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        adidas2 = new javax.swing.JButton();
        adidas1 = new javax.swing.JButton();
        ...
        adidas3.setBounds(820, 320, 350, 210);

        adidas2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/adidas2.jpeg"))); // NOI18N
        adidas2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                adidas2ActionPerformed(evt);
            }
        });
        getContentPane().add(adidas2);
        adidas2.setBounds(430, 320, 350, 210);

        adidas1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/adidas1.jpeg"))); // NOI18N
        adidas1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                adidas1ActionPerformed(evt);
            }
        });
        getContentPane().add(adidas1);
        adidas1.setBounds(40, 320, 350, 210);
        ...
        botaoVANS.setBounds(410, 30, 120, 70);
        ...
        botaoPUMA.setBounds(240, 30, 120, 70);

        botaoADIDAS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PaginaAdidas.png"))); // NOI18N
        botaoADIDAS.setContentAreaFilled(false);
        ...
        botaoADIDAS.setBounds(770, 90, 370, 200);
        ...
        botaoCadastro.setBounds(1080, 590, 90, 40);
        ...
        botaoEntrar.setBounds(1080, 540, 90, 40);
        ...
        botaoCarrinho.setBounds(970, 550, 90, 70);
        ...
        botaoNIKE.setBounds(40, 30, 130, 70);
        ...
        botaoOcelot.setBounds(-90, 70, 990, 280);
        ...
        fundoMarca.setBounds(0, -30, 1960, 1130);
    ...
    private void adidas1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adidas1ActionPerformed
        AdidasForumLow objAFL = new AdidasForumLow();
        objAFL.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_adidas1ActionPerformed

    private void adidas2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adidas2ActionPerformed
        AdidasBoost objAB = new AdidasBoost();
        objAB.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_adidas2ActionPerformed
    ...
    private javax.swing.JButton adidas1;
    private javax.swing.JButton adidas2;
