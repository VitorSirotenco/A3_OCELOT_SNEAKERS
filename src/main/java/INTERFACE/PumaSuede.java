 ...
 * @author User
 */
public class PumaSuede extends javax.swing.JFrame {

    /**
     * Creates new form PumaSuede
     */
    public PumaSuede() {
        initComponents();
        this.setTitle("PUMA SUEDE");
    }
    ...
    private void initComponents() {
        ...
        labelTenis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/puma1.jpg"))); // NOI18N
        getContentPane().add(labelTenis);
        labelTenis.setBounds(175, 157, 350, 210);

        labelTitulo.setText("PUMA SUEDE CLASSICO. PRETO E BRANCO");
        getContentPane().add(labelTitulo);
        labelTitulo.setBounds(175, 58, 245, 43);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PumaSuede.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
