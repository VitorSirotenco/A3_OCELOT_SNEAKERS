 ...
 * @author User
 */
public class VansOldPreto extends javax.swing.JFrame {

    /**
     * Creates new form VansOldPreto
     */
    public VansOldPreto() {
        initComponents();
        this.setTitle("VANS OLD PRETO");
    }
    ...
    private void initComponents() {
        ...
        labelTenis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vans3.jpeg"))); // NOI18N
        getContentPane().add(labelTenis);
        labelTenis.setBounds(184, 136, 350, 179);

        labelTitulo.setText("VANS OLD SKOOL. PRETO E BRANCO");
        getContentPane().add(labelTitulo);
        labelTitulo.setBounds(184, 50, 215, 44);
    ...
    private void botaoFinalizarCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoFinalizarCompraActionPerformed
        ...
        ten.setMarca("Vans");
        ten.setModelo("Old Skool");
        ten.setCor("Preto&Branco");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VansOldPreto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VansOldPreto().setVisible(true);
            }
        });
    }
