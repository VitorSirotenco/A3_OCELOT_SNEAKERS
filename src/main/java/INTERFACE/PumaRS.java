 ...
 * @author User
 */
public class PumaRS extends javax.swing.JFrame {

    /**
     * Creates new form PumaRS
     */
    public PumaRS() {
        initComponents();
        this.setTitle("PUMA RS");
    }
    ...
    private void initComponents() {
        ...
        tituloTenis = new javax.swing.JLabel();
        ...
        labelTitulo.setText("PUMA RS-Z CORE");
        getContentPane().add(labelTitulo);
        labelTitulo.setBounds(161, 63, 213, 25);

        tituloTenis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/puma3.jpg"))); // NOI18N
        getContentPane().add(tituloTenis);
        tituloTenis.setBounds(161, 130, 350, 188);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PumaRS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel tituloTenis;
