 ...
 * @author User
 */
public class AdidasNMD extends javax.swing.JFrame {

    /**
     * Creates new form AdidasNMD
     */
    public AdidasNMD() {
        initComponents();
        this.setTitle("ADIDAS NMD");
    }
    ...
    private void initComponents() {
        ...
        labelTenis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/adidas3.jpeg"))); // NOI18N
        getContentPane().add(labelTenis);
        labelTenis.setBounds(157, 134, 363, 210);

        labelTitulo.setText("ADIDAS NMD. PRETO, BRANCO, AZUL, VERMELHO");
        getContentPane().add(labelTitulo);
        labelTitulo.setBounds(157, 41, 287, 42);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdidasNMD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
