 ...
 * @author User
 */
public class NikeAirForce2 extends javax.swing.JFrame {

    /**
     * Creates new form NikeSB2
     */
    public NikeAirForce2() {
        initComponents();
        this.setTitle("NIKE SB");
    }
    ...
    private void initComponents() {
        ...
        labelTenis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nike1.jpeg"))); // NOI18N
        getContentPane().add(labelTenis);
        labelTenis.setBounds(146, 123, 364, 210);

        labelTitulo.setText("NIKE AIR FORCE BRANCO E ROSA");
        getContentPane().add(labelTitulo);
        labelTitulo.setBounds(146, 33, 201, 33);
        ...
        labelFundo.setBounds(0, 0, 1200, 710);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NikeAirForce2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NikeAirForce2().setVisible(true);
            }
        });
    }
