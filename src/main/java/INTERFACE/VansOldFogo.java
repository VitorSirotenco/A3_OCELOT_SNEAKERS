 ...
 * @author User
 */
public class VansOldFogo extends javax.swing.JFrame {

    /**
     * Creates new form VansOldFogo
     */
    public VansOldFogo() {
        initComponents();
        this.setTitle("VANS OLD FOGO");
    }
    ...
    private void initComponents() {
        ...
        labelTenis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vans2.jpeg"))); // NOI18N
        getContentPane().add(labelTenis);
        labelTenis.setBounds(166, 107, 350, 210);

        labelTitulo.setText("VANS OLD SKOOL EM CHAMAS");
        getContentPane().add(labelTitulo);
        labelTitulo.setBounds(166, 51, 203, 38);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VansOldFogo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VansOldFogo().setVisible(true);
            }
        });
    }
