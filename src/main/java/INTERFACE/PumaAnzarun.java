 ...
 * @author User
 */
public class PumaAnzarun extends javax.swing.JFrame {

 
    public PumaAnzarun() {
        initComponents();
        this.setTitle("PUMA ANZARUN");
    }
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("PUMA ANZARUN PRETO");
        getContentPane().add(labelTitulo);
        labelTitulo.setBounds(157, 39, 169, 40);

        labelTenis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/puma2.jpg"))); // NOI18N
        getContentPane().add(labelTenis);
        labelTenis.setBounds(157, 126, 350, 210);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PumaAnzarun().setVisible(true);
            }
        });
    }
